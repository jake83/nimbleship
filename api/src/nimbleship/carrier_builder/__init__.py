...
co-authors a draft CarrierDefinition from an onboarding packet through granular edits
to an in-memory working copy. It never publishes - the operator commits the copy as a
draft and publishes it through the existing definition rails."""
